...
def critical_findings_created(instance, created, **kwargs):
    print("Signal received!")
    if created or instance.work_type == "Repair":
        #CONTINUE HERE! ADD LOGIC IF LOG IS FOR A CRITICAL EQUIPMENT
        if instance.equipment_name.critical_asset_designation:
